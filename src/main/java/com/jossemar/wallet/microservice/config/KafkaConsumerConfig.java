package com.jossemar.wallet.microservice.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Event<?>> consumerFactory() {
        ...
        props.put(JsonSerializer.TYPE_MAPPINGS,"com.jossemar.swap.microservice:com.jossemar.swap.microservice.event.Event");
